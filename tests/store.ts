...
export const test = async () => {
  ...
  await upsertMedia(
    [
      { uri: 'anilist:1', origin: 'anilist', id: '1', url: null, score: 0.9, type: null, categories: [], status: null, titles: [{ language: 'en', title: 'Test Show' }], descriptions: [], shortDescriptions: [], trailers: [], covers: [], banners: [], averageScore: null, popularity: 1000, startDate: null, endDate: null, isAdult: null, episodeCount: null, season: null, seasonYear: null, genres: [], tags: [], scope: 'RUN' },
      { uri: 'mal:1', origin: 'mal', id: '1', url: null, score: 0.5, type: null, categories: [], status: null, titles: [{ language: 'en', title: 'Test Show' }], descriptions: [], shortDescriptions: [], trailers: [], covers: [], banners: [], averageScore: null, popularity: null, startDate: null, endDate: null, isAdult: null, episodeCount: null, season: null, seasonYear: null, genres: [], tags: [], scope: 'RUN' },
    ],
  ...
  await upsertMedia(
    [{ uri: 'anilist:1', origin: 'anilist', id: '1', url: null, score: 0.9, type: null, categories: [], status: null, titles: [], descriptions: [], shortDescriptions: [], trailers: [], covers: [], banners: [], averageScore: null, popularity: 1000, startDate: null, endDate: null, isAdult: null, episodeCount: null, season: null, seasonYear: null, genres: [], tags: [], scope: 'RUN' }],
    []
  )
  ...
  await upsertMedia(
    [{ uri: 'anilist:1', origin: 'anilist', id: '1', url: null, score: 0.9, type: null, categories: [], status: null, titles: [], descriptions: [], shortDescriptions: [], trailers: [], covers: [], banners: [], averageScore: null, popularity: 2000, startDate: null, endDate: null, isAdult: null, episodeCount: null, season: null, seasonYear: null, genres: [], tags: [], scope: 'RUN' }],
    []
  )
