...
| 4 | `resolvers/media/index.ts:156-159` | `POPULARITY` and `POPULARITY_DESC` | `POPULARITY` sorts descending and `POPULARITY_DESC` sorts ascending: the names are swapped | genuinely inverted, and unreachable |
